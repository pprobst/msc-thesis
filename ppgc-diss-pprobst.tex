...
\ppi{TODO restrictions for STRIPS and \sas.}
...
In this chapter, we introduce the proposed approach for identifying preferred operators within an existing sample set. Additionally, we present a sampling algorithm designed for discovering preferred operators.
...
\chapter{Maximum Regression Depth in Samples Generated with \bfsrs}
