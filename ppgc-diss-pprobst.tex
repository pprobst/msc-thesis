...
See \cref{alg:sampling-po}. The primary distinction between phases one and two lies in the selection process for expanding states. Unlike phase one, where the first-in, first-out approach of BFS is used, phase two involves randomly selecting a state from the open queue for expansion.
