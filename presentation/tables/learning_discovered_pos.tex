\begin{table}[tb]
\centering
\caption[]{Expansões do GBFS guiadas por \hnn sem operadores preferidos e com \poff e \pog, treinado em diferentes tamanhos de conj. de amostras.} %Rovers maintained the same results from $20\,\%$ onward as they sampled the complete backward state space, which numerically represents approximately $15\,\%$ of the forward state space. }
