...
\only<1>{Geo. mean  & 35.0 & 28.0  & 30.6 & 22.4 & 21.0 & 19.8 & 19.5 & 19.7 & 19.6 \\ \bottomrule}
\only<2>{Geo. mean  & 35.0 & \alert{28.0}  & 30.6 & \alert{22.4} & 21.0 & 19.8 & 19.5 & 19.7 & 19.6 \\ \bottomrule}
\end{tabular}
}
\end{table}
