\begin{table}[tb]
\centering
%\caption[]{Expansões do GBFS guiadas por \hnn sem operadores preferidos e com \poff e \pog, treinado em diferentes tamanhos de conjunto de amostras.} %Rovers maintained the same results from $20\,\%$ onward as they sampled the complete backward state space, which numerically represents approximately $15\,\%$ of the forward state space. }
\label{tab:learning_discovered_pos_full}
...
\cmidrule(lr){2-10}
           &     &        & \multicolumn{7}{c}{\pog} \\
\cmidrule(lr){4-10}
           & - & \poff & $1\,\%$ & $5\,\%$   & $10\,\%$ & $20\,\%$ & $30\,\%$ & $40\,\%$ & $50\,\%$ \\ \midrule
Blocks     & 57.0 & 41.1  & 43.0 & 26.2 & 29.6 & 32.2 & 34.9 & 38.0 & 38.8 \\
Grid       & 66.5 & \alert{32.7}  & 67.4 & \alert{53.0} & 46.4 & \alert{27.4} & 23.8 & 23.6 & 22.9 \\
N-Puzzle   & 80.9 & 100.2 & 53.3 & 34.8 & 31.6 & 28.5 & 28.1 & 27.4 & 27.4 \\
Rovers     & 13.4 & 18.5  & 12.2 & 11.7 & 13.0 & 17.2 & 17.2 & 17.2 & 17.2 \\
Scanalyzer & 28.3 & \alert{17.1}  & 30.7 & \alert{18.1} & 13.0 & 11.7 & 11.5 & 11.6 & 11.5 \\
