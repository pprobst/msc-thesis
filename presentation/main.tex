...
\pause
\item Os operadores preferidos de um estado $s$ é dado por $$O_{\text{pref}}(s) = \{o \mid \textblue{pre(o) \subseteq s}, \textgreen{add(o) \cap S_{1}^{*} \neq \emptyset} \}$$
...
\begin{frame}{Geração de Amostras}
\begin{itemize}
...
\begin{itemize}
  ...
  \pause
  \item \alert{\pofsm precisa de $10\times$ mais amostras} para ter resultados comparáveis a \pog.
    \begin{itemize}
      \item \pofsm $50\,\%$: $22.5$.
      \item \pog $5\,\%$: $22.4$.
    \end{itemize}
