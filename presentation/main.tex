...
\begin{tikzpicture}
  ...
  \node[black_node, label={[below, label distance=-28mm]:{$A_{2}$}}] (at) [right = of p1] {%
    \begin{tabular}{c}
      ...
    \end{tabular}
  };

  \node[black_node, label={[below, label distance=-28mm]:{$P_{2}$}}] (pt) [right = of at] {%
    \begin{tabular}{c}
      ...
    \end{tabular}
  };
...
\begin{tikzpicture}
  ...
  \node[black_node, label={[below, label distance=-49mm]:{$P_{1}$}}] (p1) [right = of a1] {%
    \begin{tabular}{c}
      \textgreen{\footnotesize on(c,b)} \\
      \footnotesize clear(a) \\
      \footnotesize on-table(a) \\
      \footnotesize on-table(b) \\
      \footnotesize clear(c) \\
  ...
  \node[black_node, label={[below, label distance=-30mm]:{$A_{2}$}}] (at) [right = of p1] {%
    \begin{tabular}{c}
      ...
    \end{tabular}
  };

  \node[black_node, label={[below, label distance=-30mm]:{$P_{2}$}}] (pt) [right = of at] {%
    \begin{tabular}{c}
      ...
    \end{tabular}
  };
...
\begin{column}{0.5\textwidth}
  ...
  \alert{$$O_{\text{pref}}(s_{0}) = \{\text{move(c,a,b)}\}$$} % on(c,b)
\end{column}
\begin{column}{0.5\textwidth}
\begin{figure}[ht]
%\centering
...
\begin{itemize}
  ...
  \only<4>{\item Nossos operadores preferidos continuam sendo úteis usando com diferentes \alert{heurísticas lógicas}? ``Ganhamos'' dos operadores preferidos do FF?}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Geramos $N$ amostras, onde $N$ é a porcentagem do tamanho do espaço de estados de cada tarefa.
    ...
    \end{itemize}
  \pause
  \item Geramos \alert{$5$} conjuntos de amostras (\emph{seeds}) para cada espaço de estados.
  \pause
  }
  \only<4>{
...
\begin{frame}{E Treinando com Mais Amostras?}
\input{tables/learning_discovered_pos_full.tex}
\begin{itemize}
