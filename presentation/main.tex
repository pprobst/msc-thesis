...
\centering
\begin{tikzpicture}
  \node[draw, circle] (A) at (0,0) {$s_0$:2};
  \node[draw, circle] (B) at (-1.7,-1) {$s_{1}$:3};
  \node[draw, circle] (C) at (1.7,-1) {$s_{2}$:1};
  \node[draw, circle] (D) at (-2.7,-2) {$s_{3}$:4};
  \node[draw, circle] (E) at (-0.7,-2) {$s_{4}$:4};
  \node[draw, circle] (F) at (0.7,-2) {$s_{5}$:2};
  \node[draw, circle] (G) at (2.7,-2) {$s^{*}$:0};
...
\begin{tikzpicture}
  \node[draw, circle] (A) at (0,0) {$s_0$:2};
  \node[draw, circle, fill=gray] (B) at (-1.7,-1) {$s_{1}$:3};
  \node[draw, circle, fill=gray] (C) at (1.7,-1) {$s_{2}$:1};
  \node[draw, circle] (D) at (-2.7,-2) {$s_{3}$:4};
  \node[draw, circle] (E) at (-0.7,-2) {$s_{4}$:4};
  \node[draw, circle] (F) at (0.7,-2) {$s_{5}$:2};
  \node[draw, circle] (G) at (2.7,-2) {$s^{*}$:0};
...
\begin{tikzpicture}
  ...
  \node[draw, circle] (D) at (-2.7,-2) {$s_{3}$:4};
  \node[draw, circle] (E) at (-0.7,-2) {$s_{4}$:4};
  \node[draw, circle, fill=gray] (F) at (0.7,-2) {$s_{5}$:2};
  \node[draw, circle, fill=gray] (G) at (2.7,-2) {$s^{*}$:0};
...
\begin{tikzpicture}
  ...
  \node[draw, circle] (E) at (-0.7,-2) {$s_{4}$:4};
  \node[draw, circle, fill=gray] (F) at (0.7,-2) {$s_{5}$:2};
  \node[draw, circle, color=myred] (G) at (2.7,-2) {$s^{*}$:0};
...
\begin{itemize}
  ...
  \item Abordagem que depende \alert{pouco} da lógica do domínio.
    \begin{itemize}
      ...
      \item Rede neural genérica, e.g., feedforward NN.
...
\begin{itemize}
  \item \emph{Sample Improvement} (SAI):
  \begin{itemize}
...
\begin{frame}{Melhorando as Estimativas das Amostras}
\begin{itemize}
  \item \emph{Successor Improvement} (SUI):
  \begin{itemize}
    \item Múltiplos rollouts podem gerar estados vizinhos.
    \begin{itemize}
      \item Podemos usar essa informação para melhorar os valores-$h$.
    \end{itemize}
    \pause
    \item Faz um grafo com todas as relações de predecessores-sucessores do conjunto de amostras.
    \pause
    \item Atualiza os valores-$h$ dos estados a um operador de distância.
  \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}{Melhorando as Estimativas das Amostras}
\ppi{Mostrar um exemplo simples.}
\end{frame}
